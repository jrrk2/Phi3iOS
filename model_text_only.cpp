...
// REMOVED MULTIMEDIA: #include "whisper.h"
// REMOVED MULTIMEDIA: #include "multi_modal.h" 
...
std::shared_ptr<MultiModalProcessor> Model::CreateMultiModalProcessor() const {
  // TEXT-ONLY BUILD: Throw error instead of creating multimedia processor
...
// TEXT-ONLY BUILD: Remove MultiModalProcessor class entirely
